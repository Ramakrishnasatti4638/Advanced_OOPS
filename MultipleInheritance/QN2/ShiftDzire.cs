...
namespace QN2
{
    public class ShiftDzire:Car,IBrand
    {
        ...
        public ShiftDzire(FuleType fuleType,int noOfSeats,string color,int tankCapacity,double numberOfKmDriven,string engineNumber,string chasisNumber,string brandName,string modelName):base( fuleType, noOfSeats, color, tankCapacity, numberOfKmDriven)
        {
            s_makingID++;
